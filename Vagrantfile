...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "ltavares-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/onipresente"
  #   chef.validation_client_name = "onipresente-validator"
  #   chef.validation_key_path = ".chef/onipresente-validator.pem"
  # end
end
